...
//Route::apiResource('users.notifications',UserNotificationController::class)->only('index'); 
...
//Route::apiResource('notifications.users', NotificationUserController::class)->only('index');// OK
// Nested Resource
