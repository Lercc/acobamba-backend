...
class DerivationObserver
{
    ...
    public function created(Derivation $derivation)
    {
       if (!\App::runningInConsole()) {
            ...
            $notification->user_type = $derivation->expedient->employee_id ? 'interno' : 'externo';
            ...
            $notification->area = $derivation->employee->office_id ? $derivation->employee->office->name :  $derivation->employee->suboffice->name;
